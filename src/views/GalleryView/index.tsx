  ...
  return (
    <div>
      <ul className="text-left font-semibold text-base mb-4">
        <li className=" mb-1"><span className='text-[#16c60c] font-semibold'> NFT Incinerator </span> : Burn scam NFTs here and get some SOL back!</li>
        <li className=" mb-1"><span className='text-[#F03A17] font-semibold'> Choose </span> which NFT you would like to burn. <strong> Make sure you do not burn Official NFTs or you will never get them back. </li>
      </ul>
